...
import { createUser, getUsers, login, logout, me, refresh } from "../controllers/auth/auth.controller";
...
authRouter.get("/users", requireAdminAuth, requireRole("ADMIN"), getUsers);
