...
interface SendSignedLetraCambioEmailParams {
  to: string;
...
export async function sendCompanySignedLetraCambioEmail({
  to,
  clienteNombre,
  pdfBuffer,
  fileName,
  ...
  const subject = `✅ Letra de cambio firmada por ${clienteNombre}`;
        ...
        <table width="620" cellpadding="0" cellspacing="0"
          ...
          <tr>
            <td style="padding:28px 32px 20px;background:linear-gradient(180deg,#ffffff 0%,#f8fbff 100%);border-bottom:1px solid #edf2fb;text-align:center;">
              ...
              <div style="display:inline-block;background:#f1f6ff;border:1px solid #d9e6ff;color:#2563eb;
                font-size:13px;font-weight:500;padding:10px 16px;border-radius:999px;">
                ● Notificación interna · Letra de cambio firmada
              </div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 34px 34px;">
              ...
              <p style="margin:0 0 14px;text-align:center;font-size:15px;line-height:1.8;color:#4b5b7c;">
                El cliente <strong>${clienteNombre}</strong> firmó correctamente la letra de cambio.
              </p>

              <p style="margin:0 0 26px;text-align:center;font-size:15px;line-height:1.8;color:#4b5b7c;">
                Se adjunta una copia de la letra de cambio firmada para registro interno.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0"
                ...
                <tr>
                  <td style="padding:20px 22px;">
                    ...
                    <p style="margin:0;font-size:14px;line-height:1.7;color:#475569;">
                      La letra de cambio fue firmada y registrada correctamente en el sistema de ${template.nombre}.
                    </p>
                  </td>
                </tr>
              </table>
