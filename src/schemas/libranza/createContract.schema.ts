  ...
  export const createContractSchema = z
    .object({
      ...
      sumaTotal: integerSchema,
      numeroCuotas: integerSchema,
      valorCuota: integerSchema,
    ...
    export const EditContractSchema = z
    .object({
      title: nullableString,
      subject: nullableString,
      amount: z.union([z.string(), z.number()]).optional().nullable(),
  ...
  export type EditContractBody = z.infer<typeof createContractSchema>;
